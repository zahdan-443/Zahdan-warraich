...
export const TripCostView: React.FC<TripCostViewProps> = ({
  ...
  const handleExportPDF = () => {
    ...
    try {
      ...
      doc.text("Generated by Al-Hadi Goods Transport Fleet Management System (Lahore, Punjab)", 14, y);
      doc.text("Authorized Signature: ___________________________", 14, y + 15);
        ...
        <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-[#ecece0]">
          <div>
            ...
            <p className="text-sm text-[#8e8e75] font-sans mt-1">
              Accurate manual logistics cost calculator & waybill generator
            </p>
          </div>
